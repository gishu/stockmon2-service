...
describe('Account', function () {
    ...
    it('can report holdings sorted alphabetically by stock name', function () {
        ...
        var trades = [make.makeBuy('2008-07-14', 'HDFCBANK', 10, '1030'),
            make.makeBuy('2009-09-03', 'HDFC', 4, '2705'),
            make.makeBuy('2009-09-13', 'COALIND', 10, '270'),
            make.makeBuy('2009-09-22', 'HDFC', 76, '1190.5'),
            make.makeSale('2009-09-23', 'HDFCBANK', 5, '1607.1'),
            make.makeSale('2009-09-31', 'COALIND', 10, '290')
        ];
    ...
    it('throws in case of insufficient balance for a sale', function () {
        var trades = [make.makeSale('2009-09-23', 'HDFCBANK', 5, '1607.1')];
        var a = account.create(1, 'Gishu');
